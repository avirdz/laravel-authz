...
class AuthzGrantUser extends Command
{
    ...
    public function handle()
    {
        ...
        $permission->users()->updateExistingPivot($user->id, ['permission_status' => Permission::GRANTED]);
        $this->info($permission->key_name . ' granted to ' . (isset($user->email) ? $user->email : $user->id));
    }
}
