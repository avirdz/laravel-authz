...
class AuthzGroupAddUser extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'authz:add-user {group} {user}';
    ...
    public function handle()
    {
        ...
        $this->info('User ' . (isset($user->email) ? $user->email : $user->id) . ' added to group ' . $group->name);
    }
}
